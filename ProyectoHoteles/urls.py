...
urlpatterns = [
    ...
    path('crear_habitaciones/', crear_multiples_habitaciones, name='crear_multiples_habitaciones'),
    ...
    path('valorar-reserva/<int:reserva_id>/', valorar_reserva, name='valorar_reserva'),
